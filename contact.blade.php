        ...
        <div mt-5 class="col-md-6 mx-auto text-center ">
            <div class="icons-row">
              <div class="secondrow-content mx-auto">
                <div class="email"> <a href="mailto:poliwiki1@gmail.com"><i class="fas fa-2x fa-envelope-square"></i></a> poliwiki1@gmail.com</div>
              ...
              <div class="social-icons">
               <!--<a href="instagram.col-md-4"><i class="fab fa-2x fa-instagram"></i></a> -->
                <a href="https://facebook.com/WikiPoli-102293344577769/"><i class="fab fa-2x fa-facebook"></i></a>
               <a href="https://twitter.com/poli_wiki?s=09"><i class="fab fa-2x fa-twitter"></i></a>
